      ...
      form.setFieldsValue({
        ...
        has_children:
          initialData.has_children !== undefined
            ...
            : undefined,
        has_criminal_record:
          initialData.has_criminal_record !== undefined
            ? Number(initialData.has_criminal_record)
            : undefined,
        has_debts:
          initialData.has_debts !== undefined
            ? Number(initialData.has_debts)
            : undefined,
        has_previous_loans:
          initialData.has_previous_loans !== undefined
            ? Number(initialData.has_previous_loans)
            : undefined,
        is_smoker:
          initialData.is_smoker !== undefined
            ? Number(initialData.is_smoker)
            : undefined,
        target_is_smoker:
          initialData.target_is_smoker !== undefined
            ? Number(initialData.target_is_smoker)
            : 0,
      });
      ...
      >
        {type === "main" ? (
          <>
            ...
            <Row gutter={24}>
              <Col span={12}>
                <Form.Item name="full_name" label="اسم مقدم الطلب">
                  <Input />
                </Form.Item>
              </Col>
              <Col span={12}>
              ...
              <Col span={8}>
                <Form.Item name="nationality" label="الجنسية">
                  <Select
                    ...
                    options={UserOptions.NATIONALITIES}
                  />
                </Form.Item>
              </Col>
              <Col span={8}>
            ...
            <Row gutter={24}>
              <Col span={12}>
                <Form.Item name="sect" label="المذهب">
                  <Select
                    options={
                      UserOptions.SECTS_BY_RELIGION[selectedReligion] ||
                      UserOptions.SECTS_BY_RELIGION.other
                    }
            ...
            {/* ✅ Fixed: arrival_date_finland */}
            <Form.Item
              name="arrival_date_finland"
              label="منذ متى أتيت إلى فنلندا؟"
              getValueFromEvent={(e) => e.target.value}
            >
              <Input
                type="date"
            ...
            <Row gutter={16}>
              ...
              <Col span={8}>
                <Form.Item name="weight" label="الوزن (كغ)">
                  <Input type="number" />
                </Form.Item>
              </Col>
              <Col span={8}>
                <Form.Item name="skin_color" label="لون البشرة">
                  <Select options={UserOptions.SKIN_COLORS} />
                </Form.Item>
              </Col>
              <Col span={8}>
                <Form.Item name="eye_color" label="لون العيون">
                  <Select options={UserOptions.EYE_COLORS} />
                </Form.Item>
              </Col>
              <Col span={8}>
                <Form.Item name="hair_type" label="نوع الشعر">
                  <Select options={UserOptions.HAIR_TYPES} />
                </Form.Item>
              </Col>
              <Col span={8}>
                <Form.Item name="hijab_status" label="حالة الحجاب">
                  <Select options={UserOptions.HIJAB_STATUS} />
                </Form.Item>
              </Col>
            </Row>
            <Form.Item
              name="distinguishing_mark"
              label="علامة مميزة (ندوب، وشوم...)"
            >
              <TextArea rows={2} />
            </Form.Item>
            ...
            <Form.Item name="current_address" label="ماهو عنوانك الحالي؟">
              <Input />
            </Form.Item>
            ...
            <Row gutter={24}>
              ...
              <Col span={12}>
                <Form.Item
                  name="children_with_me"
                  label="هل الأطفال يقيمون معك؟"
                >
                  <Input />
                </Form.Item>
              </Col>
            ...
            <Form.Item
              name="children_after_marriage"
              label="هل ترغب في أطفال بعد الزواج؟"
            >
              <Input />
            </Form.Item>
            <Form.Item name="children_info" label="معلومات إضافية عن الأطفال">
              <TextArea rows={2} />
            </Form.Item>

            <Divider orientation="right">التعليم والوضع المالي</Divider>
            <Form.Item name="education_level" label="المؤهلات العلمية">
              <Select options={UserOptions.EDUCATION_LEVELS} />
            </Form.Item>
            <Form.Item name="work_experience" label="ماهي خبراتك العملية؟">
              <TextArea rows={2} />
            </Form.Item>
            <Form.Item
              name="income_source"
              label="من أين تحصل على دخلك في فنلندا؟"
            >
            ...
            <Row gutter={24}>
              ...
              <Col span={12}>
                <Form.Item
                  name="has_previous_loans"
                  label="هل حصلت على قروض سابقا؟"
                >
                  <Radio.Group>
                    <Radio value={1}>نعم</Radio>
                    <Radio value={0}>لا</Radio>
            ...
            <Form.Item name="about_me_more" label="معلومات إضافية">
              <TextArea rows={3} />
            </Form.Item>
            ...
            <Form.Item name="info_correctness_pledge" valuePropName="checked">
              <Checkbox>أتعهد بصحة المعلومات</Checkbox>
            </Form.Item>
            <Form.Item name="contract_terms_accepted" valuePropName="checked">
              <Checkbox>أوافق على بنود العقد</Checkbox>
            </Form.Item>
            <Form.Item name="gdpr_accepted" valuePropName="checked">
              <Checkbox>أوافق على سياسة البيانات (GDPR)</Checkbox>
            </Form.Item>
          </>
        ) : (
          <>
            ...
            <Row gutter={24}>
              ...
              <Col span={12}>
                <Form.Item name="target_city" label="المدينة المطلوبة للشريك">
                  <Input />
                </Form.Item>
              </Col>
            </Row>
            ...
            <Row gutter={24}>
              ...
              <Col span={12}>
                <Form.Item name="target_sect" label="المذهب المطلوب للشريك">
                  <Select
                    options={
                      UserOptions.SECTS_BY_RELIGION[selectedTargetReligion] ||
                      UserOptions.SECTS_BY_RELIGION.other
                    }
            ...
            <Row gutter={24}>
              <Col span={24}>
                <Form.Item
                  name="target_marital_status"
                  label="الحالة الاجتماعية المطلوبة"
                >
                  <Select
                    mode="multiple"
                    options={UserOptions.MARITAL_STATUS}
                  />
                </Form.Item>
              </Col>
            </Row>
            ...
            <Row gutter={24}>
              <Col span={12}>
                <Form.Item
                  name="target_is_smoker"
                  label="هل يهم أن يكون الشريك مدخن؟"
                >
                  <Radio.Group>
                    <Radio value={1}>نعم</Radio>
                    <Radio value={0}>لا</Radio>
              ...
              <Col span={12}>
                <Form.Item
                  name="target_has_children"
                  label="هل تتقبل وجود أطفال لدى الشريك؟"
                >
            ...
            <Form.Item
              name="target_residency_type"
              label="نوع الإقامة المطلوب للشريك"
            >
              <Select mode="multiple" options={UserOptions.RESIDENCY_TYPES} />
            </Form.Item>
            <Form.Item
              name="target_religion_commitment"
              label="درجة الالتزام الديني المطلوبة"
            >
              <Select
                mode="multiple"
                options={UserOptions.RELIGION_COMMITMENT}
              />
            </Form.Item>
            <Form.Item
              name="target_special_conditions"
              label="شروط خاصة إضافية للشريك"
            >
              <TextArea rows={3} />
            </Form.Item>
          </>
