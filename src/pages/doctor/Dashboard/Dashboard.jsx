...
const Dashboard = () => {
  ...
  return (
    <div className="flex flex-col gap-6 ">
            ...
            {todaySlots.isOffDay ? (
              ...
              <div className="flex items-center gap-4 mt-3">
                <div className="flex items-center gap-2 text-white">
                  <Clock size={18} />
                  <span>{todaySlots.slots.length} slots available</span>
                </div>
              </div>
            )}
          </div>
        ...
        <Card className="!shadow-sm">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">Your scheduled breaks</p>
            </div>
          </div>
          ...
          {upcomingOffDays.length > 0 ? (
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500">{offDay.reason}</p>
                    </div>
                  </div>
                  <Tag color="orange">
                    {offDay.daysFromNow === 0
                      ? "Today"
                      : offDay.daysFromNow === 1
                        ? "Tomorrow"
                        : `In ${offDay.daysFromNow} days`}
                  </Tag>
                </div>
              ))}
            </div>
            ...
            <Empty
              ...
              description="No upcoming days off"
            />
          )}
        </Card>
        ...
        <Card className="!shadow-sm">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">Your settings overview</p>
            </div>
          </div>
      ...
      {/* Info Alert */}
      {(!stats.settings.hasMeetingLink || !stats.settings.hasInstructions) && (
